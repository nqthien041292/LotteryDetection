...
import { LotteryDetectionCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localforage.config({
        ...
        version: 1.0,
        storeName: 'lotterydetection_local_storage',
        description: 'Cached data for LotteryDetection',
    });
}
