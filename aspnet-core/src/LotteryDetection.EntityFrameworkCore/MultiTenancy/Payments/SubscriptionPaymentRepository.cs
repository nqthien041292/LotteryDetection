...
public class SubscriptionPaymentRepository : LotteryDetectionRepositoryBase<SubscriptionPayment, long>,
    ISubscriptionPaymentRepository
{
    public SubscriptionPaymentRepository(IDbContextProvider<LotteryDetectionDbContext> dbContextProvider)
