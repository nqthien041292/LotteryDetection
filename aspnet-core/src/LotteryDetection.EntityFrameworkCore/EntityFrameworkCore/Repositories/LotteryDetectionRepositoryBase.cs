...
public abstract class LotteryDetectionRepositoryBase<TEntity, TPrimaryKey> : EfCoreRepositoryBase<LotteryDetectionDbContext, TEntity, TPrimaryKey>
...
/// <summary>
/// Base class for custom repositories of the application.
/// This is a shortcut of <see cref="LotteryDetectionRepositoryBase{TEntity,TPrimaryKey}"/> for <see cref="int"/> primary key.
/// </summary>
/// <typeparam name="TEntity">Entity type</typeparam>
