...
public static class DashboardRandomDataGenerator
{
    ...
    {
        "Argentina", "China", "France", "Italy", "Japan", "Netherlands", "Russia", "Spain", "Turkey", "United States"
    };
    ...
    public static List<SalesSummaryData> GenerateSalesSummaryData(SalesSummaryDatePeriod inputSalesSummaryDatePeriod)
    {
        ...
        switch (inputSalesSummaryDatePeriod)
        {
            case SalesSummaryDatePeriod.Daily:
                ...
                {
                    new(DateTime.Now.AddDays(-5).ToString(DateFormat), Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(DateTime.Now.AddDays(-4).ToString(DateFormat), Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(DateTime.Now.AddDays(-3).ToString(DateFormat), Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(DateTime.Now.AddDays(-2).ToString(DateFormat), Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(DateTime.Now.AddDays(-1).ToString(DateFormat), Random.Next(1000, 2000),
                        Random.Next(100, 999))
                };
            ...
            case SalesSummaryDatePeriod.Weekly:
                ...
                data = new List<SalesSummaryData>
                {
                    new(lastYear + " W4", Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(lastYear + " W3", Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(lastYear + " W2", Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(lastYear + " W1", Random.Next(1000, 2000),
                        Random.Next(100, 999))
                };
            ...
            case SalesSummaryDatePeriod.Monthly:
                data = new List<SalesSummaryData>
                {
                    new(DateTime.Now.AddMonths(-4).ToString("yyyy-MM"), Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(DateTime.Now.AddMonths(-3).ToString("yyyy-MM"), Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(DateTime.Now.AddMonths(-2).ToString("yyyy-MM"), Random.Next(1000, 2000),
                        Random.Next(100, 999)),
                    new(DateTime.Now.AddMonths(-1).ToString("yyyy-MM"), Random.Next(1000, 2000),
                        Random.Next(100, 999))
                };
    ...
    public static List<MemberActivity> GenerateMemberActivities()
    {
        ...
        {
            new("Brain", LotteryDetectionConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100),
                GetRandomInt(10, 150),
                GetRandomInt(10, 99) + "%", "015-boy-6.svg"),

            new("Jane", LotteryDetectionConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100),
                GetRandomInt(10, 150),
                GetRandomInt(10, 99) + "%", "017-girl-8.svg"),

            new("Tim", LotteryDetectionConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100),
                GetRandomInt(10, 150),
                GetRandomInt(10, 99) + "%", "004-boy-1.svg"),

            new("Kate", LotteryDetectionConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100),
                GetRandomInt(10, 150),
