...
public class LotteryDetectionWebCoreModule : AbpModule
{
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(LotteryDetectionWebCoreModule).GetAssembly());
    }
    ...
    public override void PostInitialize()
    {
        ...
        IocManager.Resolve<ApplicationPartManager>()
            .AddApplicationPartsIfNotAddedBefore(typeof(LotteryDetectionWebCoreModule).Assembly);
    }
