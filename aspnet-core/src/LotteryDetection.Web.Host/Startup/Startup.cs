...
#pragma warning disable CS0162
        ...
        if (WebConsts.SwaggerUiEnabled)
        {
            ...
            {
                options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "LotteryDetection API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("LotteryDetection.Web.wwwroot.swagger.ui.index.html");
