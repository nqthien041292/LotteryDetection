...
using LotteryDetection.Web.Session;
using Microsoft.AspNetCore.Mvc;

namespace LotteryDetection.Web.Public.Views.Shared.Components.Header;

public class HeaderViewComponent : LotteryDetectionViewComponent
{
    ...
    public async Task<IViewComponentResult> InvokeAsync(string currentPageName = "")
    {
        ...
        var headerModel = new HeaderViewModel
        {
            ...
            TenantRegistrationEnabled =
                await _settingManager.GetSettingValueAsync<bool>(AppSettings.TenantManagement.AllowSelfRegistration),
    ...
    private async Task<string> GetLogoSkin()
    {
        ...
        if (theme.IsTopMenuUsed || theme.IsTabMenuUsed) return theme.BaseSettings.Layout.DarkMode ? "light" : "dark";
