...
using LotteryDetection.Configuration.Tenants;
using Shouldly;
using Xunit;

namespace LotteryDetection.Tests.Configuration.Tenants;
...
public class TenantSettingsAppService_Tests : AppTestBase
{
    ...
    private void InitializeTestSettings()
    {
        ...
        _settingManager.ChangeSettingForApplicationAsync(AppSettings.UserManagement.IsNewRegisteredUserActiveByDefault,
            "false");
    }
