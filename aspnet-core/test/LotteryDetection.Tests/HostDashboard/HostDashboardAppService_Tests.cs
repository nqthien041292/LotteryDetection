...
public class HostDashboardAppService_Tests : AppTestBase
{
    ...
    private void CreatePaidPayment(LotteryDetectionDbContext context, SubscriptionPayment subscriptionPayment)
    {
