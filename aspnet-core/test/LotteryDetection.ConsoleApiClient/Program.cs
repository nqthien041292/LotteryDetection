...
namespace LotteryDetection.ConsoleApiClient;
/*
...
internal class Program
{
    ...
    private static async Task GetUsersListAsync(string accessToken)
    {
        using (var client = new HttpClient())
        {
            ...
            var response = await client.PostAsync($"{ServerUrlBase}api/services/app/user/getUsers",
            ...
            var ajaxResponse = JsonSerializer.Deserialize<AjaxResponse<PagedResultDto<UserListDto>>>(content,
