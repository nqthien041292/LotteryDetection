...
$webHostFolder = Join-Path $slnFolder "src/LotteryDetection.Web.Host"
$webPublicFolder = Join-Path $slnFolder "src/LotteryDetection.Web.Public"
...
docker rmi lotterydetectionwebhost -f
...
docker rmi lotterydetectionwebpublic -f
docker compose -f docker-compose.yml build
...
docker rmi lotterydetectionwebangular -f
docker compose -f docker-compose.yml build
